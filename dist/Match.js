    ...
    function Match(props) {
        ...
        this.startTennisMatch = function () {
            try {
                ...
                _this.winner = '';
                console.log("Set starts. " + _this.player1Name + " and " + _this.player2Name + " are playing.");
        ...
        this.player1Scores = function () {
            try {
                ...
                console.log(_this.player1Name + " scores.");
                return _this.player1Name + " scores.";
            }
            catch (error) {
        ...
        this.player2Scores = function () {
            try {
                ...
                _this.gameScore[1]++;
                _this.checkGameScore();
                console.log(_this.player2Name + " scores.");
                return _this.player2Name + " scores.";
            }
            catch (error) {
            ...
            try {
                ...
                if ((player1SetScore > 5 || player2SetScore > 5) && setDiff > 1) {
                    if (player1SetScore > player2SetScore) {
                        ...
                        _this.gameOver = true;
                        console.log(_this.player1Name + " has won the set.");
                        return _this.player1Name + " has won the set.";
                    }
                    else {
                        _this.winner = "" + _this.player2Name;
                        _this.gameOver = true;
                        console.log(_this.player2Name + " has won the set.");
        ...
        this.getScore = function () {
            try {
                ...
                if (_this.gameOver) {
                    console.log("Match is over. " + _this.winner + " is the winner. [" + _this.setScore + "] - [" + _this.getGameScoreInText(diff, _this.gameScore[0]) + "," + _this.getGameScoreInText(diff * -1, _this.gameScore[1]) + "]");
                ...
                console.log("Score: [" + _this.setScore + "] - [" + _this.getGameScoreInText(diff, _this.gameScore[0]) + "," + _this.getGameScoreInText(diff * -1, _this.gameScore[1]) + "]");
                return "Score: [" + _this.setScore + "] - [" + _this.getGameScoreInText(diff, _this.gameScore[0]) + "," + _this.getGameScoreInText(diff * -1, _this.gameScore[1]) + "]";
            }
            catch (error) {
